...
# periodic colormap gradient from https://stackoverflow.com/a/50860105
_complex_colors = np.array([[0.91510904, 0.55114749, 0.67037311],
...
complex_cmap = col.ListedColormap(_complex_colors)
